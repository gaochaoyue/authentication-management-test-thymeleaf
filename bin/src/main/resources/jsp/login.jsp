...
<form id="form1" name="form1" action="user?action=login" method="post">
	<div class="MAIN">
		<ul>
			...
			<li class="topB">
				<span> 
					<a href="http://www.java1234.com" target="_blank"><img src="images/login/logo.gif" alt="" style="" /></a>
				</span>
			</li>
			<li class="topC"></li>
			<li class="topD">
			...
			<li class="middle_C"><span class="btn"> <img alt="" src="${request.contextPath}/static/images/login/btnlogin.gif" onclick="javascript:document.getElementById('form1').submit()"/> </span>&nbsp;&nbsp;<span ><font color="red">${error }</font></span></li>
